...
1. Kazdy agent podwykonawczy najpierw czyta:
   ...
   - aktualny przydzielony portfel, na przyklad `docs/AGENTY_PODWYKONAWCZE/PORTFEL_09_ZLECEN_DLA_PODWYKONAWCOW_2026-04-27.md`, `docs/AGENTY_PODWYKONAWCZE/PORTFEL_08_ZLECEN_DLA_PODWYKONAWCOW_2026-04-25.md` albo `docs/AGENTY_PODWYKONAWCZE/PORTFEL_07_ZLECEN_DLA_PODWYKONAWCOW_2026-04-24.md`
...
- `ODBIOR_PORTFELA_07_ZADAN_17_22_2026-04-25.md`: odbior zadan `17-22` wraz z werdyktem i otwartymi brakami przed pilotem
- `PORTFEL_08_ZLECEN_DLA_PODWYKONAWCOW_2026-04-25.md`: kolejny portfel zadan `23-28`
- `ZLECENIE_GLOWNE_23_PROJECT13_VERIFICATION_THRESHOLD_TUNING_AND_STATUS_RESOLUTION_PACKET.md`
- `ZLECENIE_GLOWNE_24_PROJECT13_CURATION_REVIEW_QUEUE_AND_EXPORT_GATE_PACKET.md`
- `ZLECENIE_GLOWNE_25_PROJECT13_VOLUNTEER_PREFLIGHT_AND_NOTEBOOK_SELF_CHECK_PACKET.md`
- `ZLECENIE_GLOWNE_26_PROJECT13_CODEOWNERS_AND_REVIEW_ENFORCEMENT_BASELINE.md`
- `ZLECENIE_GLOWNE_27_PROJECT13_BLUEPRINT_MINIMAL_EXECUTION_SURFACE_DRY_RUN.md`
- `ZLECENIE_GLOWNE_28_PROJECT13_ESP_RUNTIME_SIMULATED_PRECHECK_AND_BENCH_REPORT_TEMPLATE.md`
- `ODBIOR_PORTFELA_08_ZADAN_23_28_2026-04-27.md`: odbior zadan `23-28` z rozroznieniem rzeczy przyjetych i rzeczy nadal nieodebranych
- `PORTFEL_09_ZLECEN_DLA_PODWYKONAWCOW_2026-04-27.md`: kolejny portfel zadan `29-34`
- `ZLECENIE_GLOWNE_29_PROJECT13_CURATION_REVIEW_QUEUE_EXECUTION_AND_EXPORT_GATE_RECEIPT.md`
- `ZLECENIE_GLOWNE_30_PROJECT13_VERIFICATION_DEFERRED_OCR_AND_MANUAL_REVIEW_WORKPACK.md`
- `ZLECENIE_GLOWNE_31_PROJECT13_CURATION_HUMAN_APPROVAL_LEDGER_AND_REVIEW_RECORDING.md`
- `ZLECENIE_GLOWNE_32_PROJECT13_PUBLIC_VOLUNTEER_CANARY_PACKET_AND_RETRO_TEMPLATE.md`
- `ZLECENIE_GLOWNE_33_PROJECT13_BLUEPRINT_BRIEF_ROW_VALIDATION_AND_SMOKE_TEST_BASELINE.md`
- `ZLECENIE_GLOWNE_34_PROJECT13_ESP_RUNTIME_SIMULATED_PRECHECK_RUN_AND_PACK_ALIGNMENT.md`
...
- `MINI_HANDOFF_ZADANIE_06.md`, `MINI_HANDOFF_ZADANIE_07.md`, `MINI_HANDOFF_ZADANIE_09.md`, `MINI_HANDOFF_ZADANIE_10.md`, `MINI_HANDOFF_ZADANIE_11.md`, `MINI_HANDOFF_ZADANIE_12.md`, `MINI_HANDOFF_ZADANIE_13.md`, `MINI_HANDOFF_ZADANIE_14.md`, `MINI_HANDOFF_ZADANIE_15.md`, `MINI_HANDOFF_ZADANIE_16.md`, `MINI_HANDOFF_ZADANIE_17.md`, `MINI_HANDOFF_ZADANIE_18.md`, `MINI_HANDOFF_ZADANIE_19.md`, `MINI_HANDOFF_ZADANIE_20.md`, `MINI_HANDOFF_ZADANIE_21.md`, `MINI_HANDOFF_ZADANIE_22.md`: wyniki przyjetych prac podwykonawczych
